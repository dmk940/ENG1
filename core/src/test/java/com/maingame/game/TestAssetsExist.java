...
public class TestAssetsExist extends UnitTestInit {
    ...
    static final String[] assets = {"file1Red.png", "file1Green.png", "file2Red.png", "file2Green.png", 
    "file3Red.png", "file3Green.png", "load.png", "pause.png", "file1.png", "file2.png", "file3.png", 
